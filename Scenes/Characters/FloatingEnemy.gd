...
@export var move_speed: float = 1.5 # Velocidad de movimiento 
@export var chase_speed: float = 3.0 # Velocidad de persecución 
...
@export var projectile_scene: PackedScene # ASIGNA LA ESCENA DEL PROYECTIL AQUÍ
...
func _physics_process(delta):
	...
	# Lógica de flotamiento vertical constante
...
func _process_wander():
	...
	if wander_target == Vector3.ZERO or global_position.distance_to(wander_target) < 0.5:
		...
		# (initial_y) para mantener la altura base
